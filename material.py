...
"}")
        ...
        self.horizontalLayout.addWidget(self.title_ouput)
        spacerItem = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout.addItem(spacerItem)
        self.button_zoom_in = QtWidgets.QPushButton(self.frame)
        self.button_zoom_in.setText("")
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("images/zoom_in.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.button_zoom_out = QtWidgets.QPushButton(self.frame)
        self.button_zoom_out.setText("")
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("images/zoom_out.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"")
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 531, 598))
...
"}")
        ...
        self.text_center.setMaximumSize(QtCore.QSize(200, 16777215))
        font = QtGui.QFont()
        font.setPointSize(14)
